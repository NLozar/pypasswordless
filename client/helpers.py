...
def verifyAndParseToken(token_str: str) -> dict:
	...
	sig: bytes = base64.urlsafe_b64decode(token["signature"].encode("utf-8"))
	servicePublicKey: Ed25519PublicKey = Ed25519PublicKey.from_public_bytes(base64.urlsafe_b64decode(payload["publicKey"].encode("utf-8")))
