...
* Logging into service doesn't invalidate that session ID, effectively allowing arbitrarily many logins into that session. No big deal in this demo but something that shouldn't be happening in production environment.
